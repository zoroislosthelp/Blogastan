...
app.config['MAIL_USERNAME'] = 'peacefulshitter5@gmail.com'
app.config['MAIL_PASSWORD'] = 'cqoa gady gplv rjcm'  
app.config['MAIL_DEFAULT_SENDER'] = 'peacefulshitter5@gmail.com'
